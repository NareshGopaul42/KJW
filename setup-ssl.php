...
// This will automatically get the correct AppData path for any user
$certDir = getenv('APPDATA') . '/postgresql';
$certPath = $certDir . '/root.crt';

echo "Creating certificate in: $certDir\n";
...
if (file_put_contents($certPath, $certContent) !== false) {
    echo "Certificate saved successfully to: $certPath\n";
    echo "Path: " . realpath($certPath) . "\n";
} else {
