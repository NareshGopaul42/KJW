<?php
// Save as setup-supabase-ssl.php

// Define paths
$certDir = getenv('APPDATA') . '/postgresql';
$certPath = $certDir . '/root.crt';

echo "Setting up Supabase SSL certificate...<br>";
...
// Supabase's certificate content
$certContent = <<<'EOD'
-----BEGIN CERTIFICATE-----
...
if (file_exists($certPath)) {
    ...
    if ($cert !== false) {
        echo "Certificate can be read: Yes ✅<br>";
        echo "Certificate content matches: " . (trim($cert) === trim($certContent) ? "Yes ✅" : "No ❌") . "<br>";
    } else {
        echo "Certificate cannot be read ❌<br>";
    }
}